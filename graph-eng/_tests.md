...
Canonical test contract for the graph-eng feature set. Companion to `_spec.md`. Derived from `_user_stories.md` (behavior), `_spec.md` Part II (components), `_dx.md` (CLI/API journeys), and `_uiux.md` (browser journeys).
...
| `_uiux.md` S1..S11 | Browser flows | — | — | E2E-020..E2E-030 |
