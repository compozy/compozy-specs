...
- [x] 10.1 Reconcile the implementation-minted `untested` scenarios into journey-derived rows
- [x] 10.2 Mint/update scenario files for the request plane, routing, strategies/partial, time travel, and web surfaces
- [x] 10.3 Update journey flowcharts in `docs/qa/journeys/` (request lifecycle; time-travel lifecycle; partial-run lifecycle)
- [x] 10.4 Author this cycle's charters in `docs/qa/charters/` with the invariant-driven hot-spot selection
- [x] 10.5 Verify every entry_point ↔ surface mapping against `_dx.md`
